...
public class OptionDialogFrame extends JFrame{
	 ...
	 * @return an array of string, icons , or object, depending on the option panel selection
	 */
	public Object[] getOptions() {
		String s = optionPanel.getSelection();
		if(s.equals("String[]")) return new String[] {"Yellow", "Blue", "Red"};
		else if(s.equals("Icon[]")) return new Icon[] {new ImageIcon("yellow-boll.gif"), 
	 ...
	 * @return the  selected XXX_MESSAGE or XX_OPTION constant from the JOptionPane class
	 */
...
/**
 * A component with a painted surfaced.
*/
