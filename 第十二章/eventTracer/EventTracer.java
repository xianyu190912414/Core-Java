...
public class EventTracer {
	...
	/**
	 * Adds event tracer for all events to which this component and its children can listen
	 * @param c a component
	 */
	 ...
	 * @param c a component
	 * @param eventSet a descriptor of a listerner interface.
	 */
	public void addListener(Component c, EventSetDescriptor eventSet) {
		//make proxy object for this listner type and route all calls to the handler
