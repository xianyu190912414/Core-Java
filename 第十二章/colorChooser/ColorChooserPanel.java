...
public class ColorChooserPanel extends JPanel{
	...
	private class ModelessListener implements ActionListener {
		...
		public ModelessListener() {
			...
			dialog = JColorChooser.createDialog(ColorChooserPanel.this, "Background Color", false /* not modal 8*/, chooser,
	...
	/**
	 * This listener pops up a modeless color chooser. The panel color changed immediately when the user picks a new color.
	 */
